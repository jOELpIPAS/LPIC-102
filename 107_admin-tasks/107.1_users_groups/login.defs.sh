...
# Author:   jOELpipAS
# Date:     Jul|23|2024
# Modified: Dec|30|2024     Question 12 correction.
...
# Question 12
read -p $'\e[32m12) If yes, useradd create group with username as default, and userdel remove group if empty:\e[33m ' p12
