...
# Question 3
read -p $'\e[32m3) Enter the command for adding an interface with the IPv6 2001:db8:1::/64 and the gateway 2001:db8::3:\e[33m\n   ' p3
...
# Question 5
read -p $'\e[32m5) Enter the command for deleting an interface with the IPv6 2001:db8:1::/64 and the gateway 2001:db8::3:\e[33m ' p5
...
# Question 6
read -p $'\e[32m6) Enter the command to backup the routing table in the file /root/routes/routebak:\e[33m ' p6
...
# Question 7
read -p $'\e[32m7) Enter the command to restore the routing table from the file /root/routes/routebak:\e[33m ' p7
...
# Question 8
read -p $'\e[32m8) Enter the command for adding a default route with the address 192.168.1.1:\e[33m ' p8
