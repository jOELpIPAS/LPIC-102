...
# Question 1
read -p $'\e[32m1) The last command gets the information from what file (enter the absolute path):\e[33m ' p1
...
# Question 2
read -p $'\e[32m2) What option is used to pull the information from a file?:\e[33m ' p2
if [[ $p2 = "-f" ]]; then 
    echo '   ✅ '; echo
else
...
# Question 3
read -p $'\e[32m3) Assuming you are gOD, enter the last command that display only entries for the user qlsaico:\e[33m ' p3
...
# Question 7
read -p $'\e[32m7) Entry in the output of the w command that displays the time used by all processes attached to the tty:\e[33m ' p7
if [[ $p7 = 'jcpu' ]]; then 
    echo '   ✅'; echo
else
...
# Question 8
read -p $'\e[32m8) Entry in the output of the w command that displays the time used by the current process:\e[33m ' p8
if [[ $p8 = 'pcpu' ]]; then 
    echo '   ✅'; echo
else
