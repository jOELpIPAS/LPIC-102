...
# Question 12
read -p $'\e[32m12) Show all files open by IP 192.168.100.22 on ports 25 and 110:\e[33m ' p12
if [[ $p12 = 'lsof -i@192.168.100.22:25,110' ]]; then 
    echo '    ✅'; echo
else
    echo -e '    \e[31m❌ CORRECT ANSWER >>\e[0m lsof -i@192.168.100.22:25,110'
    echo
fi
