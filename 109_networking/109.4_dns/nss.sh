...
#           Jan|23|2025     Sleep time reduced.
#                           Q1 Correction.
#                           Q7 Extra space deleted.
...
# Question 1
read -p $'\e[32m1) Set of libraries that reads /etc/nsswitch.conf when the system starts up:\e[33m ' p1
if [[ $p1 = 'nss' ]]; then 
    echo '   ✅'; echo
else
...
echo 
echo -e "\e[0m-----------------------------------------------------"
echo -e "\e[36mIII. [STATUS-ACTIONS] /etc/nsswitch.conf\e[0m"
echo -----------------------------------------------------
echo; echo
...
# Question 1
read -p $'\e[32m1) Enter the 4 possible status, separated by a space and following this order -> s... n... u... t...:\n  \e[33m ' p1
...
# Question 2
read -p $'\e[32m2) Enter the 3 possible actions, separated by a space and following this order -> r... c... m...:\n  \e[33m ' p2
...
# Question 2
read -p $'\e[32m2) Enter the [status=action] to indicate that if the lookup succeeded but the service was not found, stop looking:\n  \e[33m ' p2
...
# Question 3
read -p $'\e[32m3) Enter the [status=action] to indicate that if the service is not available, try the next one:\n  \e[33m ' p3
