...
# Modified: Jan|15|2025     Line 59 error fixed.
#           Jan|16|2025     Question 9: CIDR added.
...
if [[ $p3 = "11.159.255.255" ]]; then 
    ...
    echo -e '   \e[31m❌ CORRECT ANSWER >>\e[0m 11.159.255.255'
    echo
fi
...
# Question 9
read -p $'\e[32m9) 128.50.64.0/19:\e[33m ' p9
