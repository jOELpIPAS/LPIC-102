...
# Question 27
read -p $'\e[32m27) Using the mail command, send a message to pipas@kk.com with the file kk.tar.gz as an attachment, and the output of \'uname -a\' as the email body:\n   \e[33m ' p27
