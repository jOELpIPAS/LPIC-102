...
# Question 4
read -p $'\e[32m4) chronyc command that displays information about the current time sources that chronyd is accessing:\n  \e[33m ' p4
if [[ $p4 = "sources" ]]; then 
    echo '   ✅'; echo
else
...
# Question 3
read -p $'\e[32m3) Difference between the measurements from the reference source and the frequency currently being used:\n  \e[33m ' p3
...
# Question 4
read -p $'\e[32m4) It can have these values: Normal, Insert second, Delete second or Not Synchronized:\e[33m ' p4
...
# Question 6
read -p $'\e[32m6) The reference ID and name (or IP address) of the server to which the computer is currently synchronised:\n  \e[33m ' p6
...
# Question 8
read -p $'\e[32m8) Total of the network path delays to the stratum-1 computer from which the computer is being synchronised:\n  \e[33m ' p8
