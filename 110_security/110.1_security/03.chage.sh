...
#           Jan|24|2025 Sleep time reduced.
#                       Section 2, Q2-10: \n
...
# Question 2
read -p $'\e[32m2) Set the password expiration date to 10 days for the user wnpitiao, using the short option format:\n  \e[33m ' p2
...
# Question 3
read -p $'\e[32m3) Disable the password expiration for the user named pupa, using the long option format:\n  \e[33m ' p3
...
# Question 4
read -p $'\e[32m4) Set the expiration date Aug 25th 2550 for the user qlsaico, using the short option format:\n  \e[33m ' p4
...
# Question 6
read -p $'\e[32m6) Show the account aging information of the user raskolnikov, using the long option format:\n  \e[33m ' p6
...
# Question 9
read -p $'\e[32m9) Set 5 days of inactivity after the password of qlsaico has expired, using the short option format:\n  \e[33m ' p9
